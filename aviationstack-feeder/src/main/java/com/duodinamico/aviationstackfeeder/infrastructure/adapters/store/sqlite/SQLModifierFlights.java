...
public class SQLModifierFlights {
    ...
    public void insert(Statement statement, FlightModel flight) throws SQLException {
        try {
            if (flight.getLiveStatusTimeStamp() != null && flight.getArrivalTimezone() != null && flight.getDepartureAirport() != null && !(flight.getDepartureAirport().contains("'")) && !(flight.getArrivalAirport().contains("'"))) {
            ...
            else if (flight.getLiveStatusTimeStamp() == null && flight.getArrivalTimezone() != null && flight.getDepartureAirport() != null && !(flight.getDepartureAirport().contains("'")) && !(flight.getArrivalAirport().contains("'"))) {
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
                statement.execute("create table if not exists flights(" +
                        "    flight_icao text," +
                        "    query_time text," +
